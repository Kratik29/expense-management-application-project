...
// income turnover in percent
  const totalIncomeTurnoverPercent =(totalIncomeTurnover / totalTurnover) * 100;
  // expense turnover in percent
  ...
  return (
    <>
      <div className="row m-3">
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="d-flex flex-column align-items-center">
                ...
                <Progress type="circle" strokeColor={"red"} className="mx-2 mt-3"
        ...
        <div className="col-md-3">
          <div className="card">
            <div className="card-header bg-primary">Total TurnOver : {totalTurnover}</div>
            <div className="card-body">
